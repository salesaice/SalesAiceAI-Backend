...
class BaseAgent(models.Model):
    ...
    operating_hours = models.JSONField(
        default=dict,
        help_text="Time windows when agent is operational"
    )
    ...
    # ================================
    # ENHANCED FIELDS - BUSINESS INFO
    # ================================
    business_info = models.JSONField(
        default=dict,
        help_text="Business information including company_name, company_website, company_phone, industry, business_description"
    )
    ...
    knowledge_files = models.JSONField(
        default=dict,
        help_text="File paths for knowledge base: product_catalog, training_scripts, faq_document, company_brochure, competitor_analysis"
    )
    
    # ================================
    # CONVERSATION SETTINGS
    # ================================
    conversation_settings = models.JSONField(
        default=dict,
        help_text="Advanced conversation settings: max_call_duration, follow_up_enabled, objection_handling_enabled, etc."
    )
    ...
    integrations = models.JSONField(
        default=dict,
        help_text="Integration settings for CRM, calendar, email systems"
    )
    
    # ================================
    # PERFORMANCE CONFIG
    # ================================
    performance_config = models.JSONField(
        default=dict,
        help_text="Performance targets and analytics configuration"
    )
    ...
    compliance_settings = models.JSONField(
        default=dict,
        help_text="Compliance and security settings: call_recording, gdpr_compliant, data_retention, etc."
    )
    
    # ================================
    # WEBHOOK SETTINGS
    # ================================
    webhook_settings = models.JSONField(
        default=dict,
        help_text="Custom webhook URLs for call events"
    )
    ...
    learning_config = models.JSONField(
        default=dict,
        help_text="AI learning and optimization settings"
    )
